  ...
  (this.elem = null),
    ...
    (this.init = function() {
      ...
      if ((this.elem = document.getElementById(elemId))) {
        var that = this;
        this.canPause &&
          (this.addToHandler(this.elem, "onmouseover", function(t) {
            that.canScroll = !1;
          }),
        ...
        for (var i = 0, elem, func, len = btnFuncs.length; len > i; i++)
          (elem = document.getElementById(this.elemId + btnFuncs[i])) &&
    ...
    (this.control = function() {
      this.canScroll &&
        (1 & this.plane &&
          (((1 == this.yDir && this.elem.scrollTop < this.y + this.yInc) ||
            (-1 == this.yDir && this.elem.scrollTop > this.y + this.yInc)) &&
            (this.endStop ? (this.plane &= 2) : (this.yDir = -this.yDir)),
          (this.y = this.elem.scrollTop),
          (this.elem.scrollTop += this.yInc = this.step * this.yDir)),
        2 & this.plane &&
          (((1 == this.xDir && this.elem.scrollLeft < this.x + this.xInc) ||
            (-1 == this.xDir && this.elem.scrollLeft > this.x + this.xInc)) &&
